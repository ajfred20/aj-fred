        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-12 gap-5">
          ...
          <div className="col-span-6 row-span-2 relative rounded-xl overflow-hidden group h-[500px]">
            ...
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm transition-all duration-300 group-hover:bg-transparent group-hover:backdrop-blur-none p-6 flex flex-col justify-end">
              <Link href="/about">
                <div className="absolute top-4 right-4 bg-black/40 backdrop-blur-sm p-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity group">
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-4 h-4 transform transition-transform duration-300 group-hover:rotate-90"
                  >
                    <path
                      strokeLinecap="round"
              ...
              <p className="text-sm text-neutral-300 tracking-tight font-normal">
                As a fullstack developer, I wield the power of code like Gojo
                Satoru wields his limitless technique. I am the honored one of
                web development.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-3 relative rounded-xl overflow-hidden group h-[240px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent p-4 flex flex-col justify-end">
              ...
              <h3 className="text-lg font-medium tracking-tight">Chimly</h3>
              <p className="text-xs text-neutral-300">AI-powered PM</p>
            </div>
          </div>
          ...
          <div className="col-span-3 relative rounded-xl overflow-hidden group h-[240px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent p-4 flex flex-col justify-end">
              ...
              <h3 className="text-lg font-medium tracking-tight">Hustle</h3>
          ...
          <div className="col-span-6 relative rounded-xl overflow-hidden group h-[240px]">
            ...
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm transition-all duration-300 group-hover:bg-transparent group-hover:backdrop-blur-none p-4 flex flex-col justify-end">
              ...
              <h3 className="text-lg font-medium tracking-tight">Bucx</h3>
              <p className="text-xs text-neutral-300">
                Stablecoin Wallet Platform
              </p>
            </div>
          </div>
          ...
          <div className="col-span-3 relative rounded-xl overflow-hidden group h-[240px]">
            ...
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm transition-all duration-300 group-hover:bg-transparent group-hover:backdrop-blur-none p-4 flex flex-col justify-end">
              ...
              <h3 className="text-lg font-medium tracking-tight">Maison</h3>
              <p className="text-xs text-neutral-300">
          ...
          <div className="col-span-6 bg-neutral-800 rounded-xl p-6 flex flex-col justify-between">
            <div>
              <h3 className="text-xl font-semibold tracking-tight mb-1">
                Get access to weekly newsletters on tricks and tips
              </h3>
              <p className="text-sm text-neutral-400">
                Get updates and tricks on design
              </p>
            </div>
          ...
          {/* Headphones Card */}
          <div
            className="col-span-3 relative rounded-xl overflow-hidden group h-[240px] bg-neutral-900 cursor-pointer"
            onClick={() =>
              window.open(
                "https://open.spotify.com/playlist/6O1ZLAZfwV6vO9SD8xP7hx?si=bd9d70af97e04811&pt=2e88b22632fecf78ea85d06187aab6da",
                "_blank"
              )
            }
          >
